...
+ [Sebastian Lugo](www.linkedin.com/)

+ [Alejandro León](www.linkedin.com/)

### Mentor:
+ [Claudio A. Gauna](www.linkedin.com/)
...
The generative-retriever model is referred to as the code that gets the user query, gets relevant information about it, and generated an according answer to the user. 
### Agent
